...
const InterestDataSource = () => {
  ...
  const [UserInterestList] = useState([
    { name: "Fashion", id: 1, pushInterest: false },
    { name: "Politics", id: 2, pushInterest: false },
    { name: "Media", id: 3, pushInterest: false },
    { name: "Art", id: 4, pushInterest: false },
    { name: "Sports", id: 5, pushInterest: false },
    { name: "Technology", id: 6, pushInterest: false },
    { name: "Science", id: 7, pushInterest: false },
    { name: "Commerce", id: 8, pushInterest: false },
    { name: "Lifestyle", id: 9, pushInterest: false },
    { name: "Education & books", id: 10, pushInterest: false },
    { name: "tools", id: 11, pushInterest: false },
    { name: "Food", id: 12, pushInterest: false },
  ]);
  ...
  const removeInterest = async (Interest) => {
    const newInterest = interests.filter(
      (newItem) => newItem.id !== Interest.id
    );
    setInterests(newInterest);
  };
